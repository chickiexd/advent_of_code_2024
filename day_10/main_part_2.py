...
def main():
    ...
    for t in trailheads:
        crnt_path = []
        results = []
        find_path(input, t, 0, results, crnt_path)
        res += len(results)
